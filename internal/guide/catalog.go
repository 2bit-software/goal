...
//line catalog.goal:109
func catalogCodesForFeature(key string) []diagDoc {
	/*line catalog.goal:110*/ if key == "" {
		/*line catalog.goal:111*/ return nil
	}
	/*line catalog.goal:113*/ var codes []diagDoc

	/*line catalog.goal:114*/
	for _, d := range diagnosticCatalog {
		/*line catalog.goal:115*/ if d.Feature == key {
			/*line catalog.goal:116*/ codes = append(codes, d)
		}
	}
	/*line catalog.goal:119*/ sort.Slice(codes, func(i, j int) bool {
		/*line catalog.goal:119*/ return codes[i].Code < codes[j].Code
	})
	/*line catalog.goal:120*/ return codes
}

//line catalog.goal:124
func catalogCodes() map[string]bool {
	/*line catalog.goal:125*/ out := make(map[string]bool, len(diagnosticCatalog))
	/*line catalog.goal:126*/ for _, d := range diagnosticCatalog {
		/*line catalog.goal:127*/ out[d.Code] = true
	}
	/*line catalog.goal:129*/ return out
}

//line catalog.goal:136
func CatalogCodes() map[string]bool {
	/*line catalog.goal:137*/ return catalogCodes()
}
