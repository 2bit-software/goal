...
func catalogCodes() map[string]bool {
	/*line catalog.goal:109*/ out := make(map[string]bool, len(diagnosticCatalog))
	/*line catalog.goal:110*/ for _, d := range diagnosticCatalog {
		/*line catalog.goal:111*/ out[d.Code] = true
	}
